  ...
  return (
    <div className="flex flex-col items-center gap-2 m-8 w-full rounded-3xl border border-solid border-white p-4 h-fit">
      ...
      <div className="flex items-start gap-2 self-stretch w-full">
        ...
        <Button className="button-1 flex justify-center items-center gap-2 py-2 px-4 rounded-2xl bg-white text-2 text-[#00b7aa] font-medium leading-6 capitalize w-full">
          Copy
        </Button>
      </div>
    </div>
